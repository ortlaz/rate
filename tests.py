...
class Tests(unittest.TestCase):
	...
	def test_create_new_param(self):
		...
		etalon = pd.DataFrame([{'Название':'вар', 'ж':9.0},{'Название':'авр', 'ж':41.0},
			{'Название':'вара', 'ж':5.0},{'Название':'рвр', 'ж':44.0},{'Название':'пв', 'ж':9.0}])
		...
		self.assertTrue(create_new_param('<ф>+<t>', big_tbl, parameters, 'Новый параметр', our_df), error_no_param+'t')
